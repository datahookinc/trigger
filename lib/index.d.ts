...
export declare type Table<T extends TableEntry> = {
    ...
    deleteRows(where?: Partial<Omit<T, '_pk'>> | ((v: T) => boolean), batchNotify?: boolean): number;
    ...
    updateRows(setValue: Partial<Omit<T, '_pk'>> | ((v: T) => Partial<Omit<T, '_pk'>>), where?: Partial<Omit<T, '_pk'>> | ((v: T) => boolean), batchNotify?: boolean): T[];
